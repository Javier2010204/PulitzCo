...
class ConferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conference" do
    assert_difference('Conference.count') do
      post conferences_url, params: { conference: { date: @conference.date, description: @conference.description, name: @conference.name, place: @conference.place, user_id: @conference.user_id } }
    end
  ...
  test "should update conference" do
    patch conference_url(@conference), params: { conference: { date: @conference.date, description: @conference.description, name: @conference.name, place: @conference.place, user_id: @conference.user_id } }
